            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12">
                    ...
                    <nav class="bread-crumb">
                        <ul class="breadcrumb clearfix"><li><a href="index.php">sagmarks</a><span class="divider"></span></li><li class="active">FAQs</li></ul>                    </nav>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            <div class="row" style="padding-bottom: 100px;">
                ...
                <div class="container">
                    ...
                    <button type="button" class="btn btn-info" data-toggle="collapse" data-target="#demo">What information can be found in my health record</button>
                    <div id="demo" class="collapse">
                        ...
                        <ul class="list-group">
                            <li class="list-group-item">Your medical history and your family’s medical history</li>
                            <li class="list-group-item">Labs and x-rays</li>
                            <li class="list-group-item">Medications prescribed</li>
                            <li class="list-group-item">Alcohol use and sexual activity</li>
                            <li class="list-group-item">Details about your lifestyle (smoking, exercise, recreational drug use, high-risk sports, stress levels)</li>
                            <li class="list-group-item">Doctor/nurse notes</li>
                            <li class="list-group-item">Results of operations and proceduresGenetic testing</li>
                            <li class="list-group-item">Research participation</li>
                            <li class="list-group-item">Any Information you provide on applications for disability, life or accidental insurance with private insurers or government programs</li>
                            <li class="list-group-item">Driver’s License</li>
                            <li class="list-group-item">Social Security Number</li>
                            <li class="list-group-item">Financial information such as credit cards and payment info</li>
                        </ul>
                        Financial information such as credit cards and payment info<br />
                    </div>

                    <button type="button" class="btn btn-info" data-toggle="collapse" data-target="#demo2">Who has access to my health records</button>
                    <div id="demo2" class="collapse">
                        <p>Many more people than you would ever want, including people outside the health care industry.</p>
                        <ul class="list-group">
                            <li dir="ltr" class="list-group-item">Insurance companies</li>
                            <li dir="ltr" class="list-group-item">Government agencies especially if you receive Medicare, Medicaid, SCHIP, SSI, Workers Comp or any local, state or federal assistance</li>
                            <li dir="ltr" class="list-group-item">Employers</li>
                            <li dir="ltr" class="list-group-item">Banks, Financial Institutions</li>
                            <li dir="ltr" class="list-group-item">Researchers</li>
                            <li dir="ltr" class="list-group-item">If you are involved in a court case, your health records can be subpoenaed and available to the public</li>
                            <li dir="ltr" class="list-group-item">Marketers</li>
                            <li dir="ltr" class="list-group-item">Drug companies</li>
                            <li dir="ltr" class="list-group-item">Data miners</li>
                            <li dir="ltr" class="list-group-item">Transcribers in and outside the U.S.</li>
                            <li dir="ltr" class="list-group-item">Many health websites collect information about you</li>
                        </ul>
                    </div>
                    <button type="button" class="btn btn-info" data-toggle="collapse" data-target="#demo3">Can my personal health information be used and disclosed without any notice to me or without my informed consent at the time of treatment</button>
