...
<div id="wrapper">
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12">
                    ...
                    <nav class="bread-crumb">
                        <ul class="breadcrumb clearfix"><li><a href="index.php">sagmarks</a><span class="divider"></span></li><li class="active">Contact</li></ul>                    </nav>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="contact-page clearfix" style="padding-bottom: 0;">
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12">
                                    ...
                                    <div class="vc_row wpb_row vc_row-fluid"><div class="wpb_column vc_column_container vc_col-sm-12"><div class="vc_column-inner "><div class="wpb_wrapper">
                                                    <div class="wpb_text_column wpb_content_element ">
                                                        <div class="wpb_wrapper">
                                                            <h2>Get in Touch</h2>
                                                            <p>Please use the form below to contact us about Sagmarks. We will reply as soon as possible.</p>
                ...
                <div class="col-lg-5 col-md-5 col-sm-6 ">
                    <form id="contact_form" class="contact-form" action="http://sagmarks.com/wp-admin/admin-ajax.php" method="post">
                        <div class="row">
                            ...
                            <div class="col-sm-12">
                                <input type="hidden" class="form-control" name="action" value="send_message"/>

                                <input type="hidden" class='form-control' name="nonce" value="9285ac7333"/>

                                <textarea name="message" id="message" class="form-control" cols="30" rows="5" placeholder="Message"></textarea>
                            </div>


                            <div class="col-lg-12 col-md-12 col-sm-12">
                                <br />
                                <input id="contact-form-submit" class="btn btn-primary" type="submit" value="SUBMIT" style="margin-bottom: 20px;">
                ...
                <div class="col-lg-6 col-md-6 col-sm-6  col-lg-offset-1 col-md-offset-1">
                    <div class="contact-sidebar clearfix" style="background-color: #ffffcc; border-left: 6px solid #ffeb3b; padding-left: 10px; ">
                        <article class="address-area clearfix">
                            <h2><span>Contact Details</span></h2>                                <div class="row">
                                <div class="col-lg-6 col-md-6 col-sm-12 ">
                                    <address><strong><big>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Mr. Anil Kumar</big></strong><br><br>

                                        <strong>Email:</strong>
                                        info@sagmarks.com
                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;data@sagmarks.com<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;sagmarksrp@gmail.com
<br />
                                    <span>

                                        <strong>Phone :</strong>&nbsp;8851636596
                                    </span>
                                        <span class=" ">
                                            <br />
                                            <strong><span>Social :</span></strong>

                                                <span class="twitter-icon"><a target="_blank" href="#">
                                                        &nbsp;
                                                        <i class="fa fa-twitter"></i></a></span>
                                                <span class="facebook-icon">
                                                    &nbsp;
                                                    <a target="_blank" href="https://www.facebook.com/3dsagmarks/">
                                                        <i class="fa fa-facebook"></i></a></span>
                                                <span class="google-icon">
                                                    &nbsp;
                                                    <a target="_blank" href="#"><i class="fa fa-google-plus">
                                                        </i>
                                                    </a></span>
                                        </span>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class=" col-lg-4 col-md-4 col-sm-4 col-xs-12  ">
                    <section id="text-1" class="widget animated fadeInLeft widget_text"><h3 class="title">About Sagmarks</h3>			<div class="textwidget"><p>we are a company providing 3D printed models and surgical guides to the medical professionals.<br />
                                <span style="display:none;"><a href="https://www.intlum.com/">website design company in kolkata</a></span></p>
                        </div>
                    </section>            </div>

                <div class=" col-lg-4 col-md-4 col-sm-4 col-xs-12  ">
                    <section id="nav_menu-2" class="widget animated fadeInLeft widget_nav_menu"><h3 class="title">Site Links</h3><div class="menu-footer-menu-1-container"><ul id="menu-footer-menu-1" class="menu"><li id="menu-item-214" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-214"><a href="http://sagmarks.com/">Home</a></li>
                                <li id="menu-item-212" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-212"><a href="http://sagmarks.com/terms-and-conditions/">Terms and Conditions</a></li>
                                <li id="menu-item-213" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-213"><a href="http://sagmarks.com/privacy-policy/">Privacy Policy</a></li>
                            </ul></div></section>            </div>
                    ...
                    <div class="footer-bottom animated fadeInDown clearfix">
                        <div class="row">
                            <div class="col-lg-7 col-md-7 col-sm-7 col-xs-12 ">
                                <p>© Copyright sagmarks 2016.</p>
                            </div>
                            <div class="col-lg-5 col-md-5 col-sm-5 col-xs-12  clearfix">
                                <ul class="footer-social-nav">
                                    <li><a target="_blank" href="#"><i class="fa fa-twitter"></i></a></li><li><a target="_blank" href="https://www.facebook.com/3dsagmarks/"><i class="fa fa-facebook"></i></a></li><li><a target="_blank" href="#"><i class="fa fa-google-plus"></i></a></li>                                </ul>
                            </div>
                        </div>
                    </div>
                </div>
...
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyD8uJ0z1vAQ7OH0AwD59DTLCCeudjaKDDE&callback=myMap"></script>
<div class="map">
    <div class="mapouter"><div class="gmap_canvas"><iframe width="100%" height="500" id="gmap_canvas" src="https://maps.google.com/maps?q=%20Nimta%2C%20Rabindra%20Sarani%2C%20Durga%20Nagar%2C%20North%20Dumdum%2C%20Kolkata%2C%20West%20Bengal%20700049&t=&z=12&ie=UTF8&iwloc=&output=embed" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"></iframe><a href="http://www.embedgooglemap.net">embedgooglemap.net</a></div><style>.mapouter{overflow:hidden;height:500px;width:100%;}.gmap_canvas {background:none!important;height:500px;width:100%;}</style></div>
</div>
