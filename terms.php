...
<div id="wrapper">
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12">
                    ...
                    <nav class="bread-crumb">
                        <ul class="breadcrumb clearfix"><li><a href="index.php">sagmarks</a><span class="divider"></span></li><li class="active">Terms and Conditions</li></ul>                    </nav>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row animated fadeInRight clearfix">
        <h1 style="padding-bottom: 30px;"><center>Terms and Conditions</center></h1>
    </div>
    <div class="contact-page clearfix" style="padding-bottom: 0px;">
        <div class="container">
            <div class="row animated fadeInRight clearfix">

                <div class="col-sm-12" style="background: #eaf6ea; margin-bottom: 40px; font-size: 17px; padding-top: 10px; padding-bottom: 10px;">
                    Lorem ipsum dolor sit amet, consectetur adipisicing elit. Hic facere nesciunt nisi quo debitis aperiam tempore id. Cum voluptatem dolorum nostrum, officia dolores iure dignissimos cupiditate dolorem ullam beatae, harum velit corporis nesciunt modi a animi ut libero nihil accusamus, aliquid eum obcaecati. Atque, non?
                    Aspernatur, voluptas saepe. Officia, deserunt, tempore! Possimus at veniam voluptate aliquid illo sunt iste iure! Suscipit maxime error aliquid, placeat dolorem quaerat tempora officia, officiis voluptates quae tempore maiores reprehenderit dicta sequi est eaque porro adipisci perferendis magni assumenda.
                    Perspiciatis nam sed nisi accusamus debitis nulla beatae sunt aspernatur libero porro laborum, tempore dolore dignissimos. Aspernatur, voluptas saepe. Officia, deserunt, tempore! Possimus at veniam voluptate aliquid illo sunt iste iure!
