...
<div id="wrapper">
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12">
                    ...
                    <nav class="bread-crumb">
                        <ul class="breadcrumb clearfix"><li><a href="index.php">sagmarks</a><span class="divider"></span></li><li class="active">Membership</li></ul>                    </nav>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <h1 style="padding-bottom: 300px;"><center>Membership</center></h1>
    </div>
