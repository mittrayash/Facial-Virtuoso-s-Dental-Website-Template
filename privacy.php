...
<div id="wrapper">
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12">
                    ...
                    <nav class="bread-crumb">
                        <ul class="breadcrumb clearfix"><li><a href="index.php">sagmarks</a><span class="divider"></span></li><li class="active">Privacy Policy</li></ul>                    </nav>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row animated fadeInRight clearfix">
        <h1 style="padding-bottom: 30px;"><center>Privacy Policy</center></h1>
    </div>
