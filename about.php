...
<div id="wrapper">
 ...
 <!--   <header class="header sticky-header">
        <div class="header-inner">
            <div class="container">
                <a href="#" class="site-logo" title="Dental">
                    <img src="images/logo.jpg" alt="Simple Logo" style="height: 100px;">
                </a>
   ...
   <!--                 <div class="header-info-box">
                        ...
                        <div class="info-box-title">Phone here</div>
                        <p>Timings Here</p>
                    </div><!-- End .header-info-box -->
    <!--            </div><!-- End header-info-boxes -->
    <!--        </div><!-- End .container -->
    <!--     </div><!-- End .header-inner -->
    <!--      <div class="header-bottom" style="background-color: #1d1e1f !important;">
            <div class="container">
                <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#main-nav-container" aria-expanded="false">
                    <span class="toggle-text">Menu</span>
                    <span class="toggle-wrapper">
                ...
                <div class="collapse navbar-collapse" id="main-nav-container">
                    <ul class="nav navbar-nav">
                        ...
                        <!-- <li class="dropdown">
                            <a href="index.php/Dental/aboutus" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false" class="info-box-title">ABOUT US <span 	glyphicon glyphicon-menu-down></span></a>
                            <ul class="dropdown-menu" role="menu">
                                <li class="drop_br as" >
                                    <a class="dropdown-toggle as" href="#">MEET THE TEAM</a>
                                </li>
                                <li class="drop_br as" >
                                    <a class="dropdown-toggle as" href="#">HAPPY CLIENTS</a>
                                </li>
                            </ul>
                        </li> -->
    <!--              <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false" class="info-box-title">Services &nbsp;<span class="	glyphicon glyphicon-menu-down"></span></a>
                    <ul class="dropdown-menu" role="menu">



                        <li class="drop_br">
                            <a href="services.php#3D" class="dropdown-toggle as ">3D printed models</a>
                        </li>
                        <li class="drop_br">
                            <a href="services.php#implant" class="dropdown-toggle as ">Patient specific implants</a>
                        </li>
                        <li class="drop_br">
                            <a href="services.php#surgical" class="dropdown-toggle as ">Surgical Guides</a>
                        </li>

                        <li class="drop_br">
                            <a href="services.php#guides" class="dropdown-toggle as ">Guides for dental implant placement</a>
                        </li>
                ...
                <li>
                    <a href="membership.php" class="info-box-title">Membership</a>
                </li>
                <li>
                ...
                <!-- <li style="float: right;">
                    <a  href="index.php/Dental/appointment" style="background: #010101; color:#fff;">BOOK AN APPOINTMENT</a>
                </li> -->
    <!--               </ul>
             </div>
         </div>
...
<script>
    ...
    <div class="row animated fadeInRight clearfix">
        <h1 ><center>About us</center></h1>
    </div>
    <div class="contact-page clearfix "  style="padding-bottom: 0px;">
        <div class="container">
            <div class="row animated fadeInRight clearfix" style="padding-bottom: 100px;">

                <p>
                    Sagmarks is pioneer in innovating surgical guide and patient specific implants in India.We provide 3D printed models of the diseased part of the patient to help understand the disease in three dimension.  Our innovative surgical guides helps to execute the surgical procedures accurately and confidently.The various deformities require patient specific implants to restore normal form and function. We have a wide experience in production of such customised implants.The placement of dental implants is an exacting science and nothing other than a surgical guide can achieve the correct orientation.We have a team of surgeons from various specialities to provide the expert inputs.
                </p>
